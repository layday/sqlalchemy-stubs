...
class Session(_SessionClassMethods):
    ...
    def refresh(self, instance, attribute_names: Optional[Any] = ..., lockmode: Optional[Any] = ...) -> None: ...
    ...
    def bulk_save_objects(self, objects, return_defaults: bool = ..., update_changed_only: bool = ...) -> None: ...
    ...
    def is_modified(self, instance, include_collections: bool = ..., passive: bool = ...) -> bool: ...
    @property
    def is_active(self): ...
    @property
    def dirty(self): ...
